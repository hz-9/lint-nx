...
describe('@hz-9/eslint-config-airbnb-ts', () => {
  ...
  it('should load sub-profiles', () => {
    expect(() => require('../profile/airbnb-ts')).not.toThrow()
    expect(() => require('../profile/airbnb-prettier')).not.toThrow()
  })

  it('should load rule modules', () => {
    expect(() => require('../airbnb-ts-rules/best-practices')).not.toThrow()
    expect(() => require('../airbnb-ts-rules/errors')).not.toThrow()
    expect(() => require('../airbnb-ts-rules/imports')).not.toThrow()
    expect(() => require('../airbnb-ts-rules/ts-off')).not.toThrow()
